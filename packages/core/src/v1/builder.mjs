...
const { sumTo, newDomEl, addNewDomEl } = utils
import * as pixiHelpers from './graphics.mjs'
import * as game from './game.mjs'
const { GameCommon, Scene, DefaultScene, GameObject, ObjectLink } = game

// Import HTML custom elements (registers them as side effect)
import './html_custom_elements.mjs'
